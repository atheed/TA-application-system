        ...
        return (
            <div>
                ...
                <div className="cart">
                    ...
                    <Button color="danger" size="lg" className="wider" onClick={this.goToCourseSelect} className="button">
                        Go Back To Course Select
                    </Button>{' '}
                    <Button color="primary" size="lg" className="wider" onClick={this.submitRankings} className="button">
                        Submit Rankings
                    </Button>
                    <br /><br />
